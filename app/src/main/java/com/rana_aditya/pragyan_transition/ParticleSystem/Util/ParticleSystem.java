package com.rana_aditya.pragyan_transition.ParticleSystem.Util;

import android.opengl.GLES20;
import android.util.Log;

import com.rana_aditya.pragyan_transition.interfaces.Renderable;
...
public class ParticleSystem implements Renderable {
    ...
    public ParticleSystem(ParticleSystemRenderer renderer, FloatBuffer vertexBuffer) {
        ...
        Log.d("generated in %d ms", "" + (System.currentTimeMillis() - startTime));
        ...
        Log.d("done in %d ms", "" + (System.currentTimeMillis() - startTime));
    }
