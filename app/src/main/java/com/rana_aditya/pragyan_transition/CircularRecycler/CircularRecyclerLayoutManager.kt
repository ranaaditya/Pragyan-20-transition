...
class CircularRecyclerLayoutManager(
        private var itemsPerCircle: Int = 6,
        ...
        private var canScrollHorizontally: Boolean = false,
    ...
    fun  initialize(itemsPerCircle: Int , anglePerItem: Double,firstCircleRadius: Double ,
                    angleStepForCircles: Double , canScrollHorizontally: Boolean , canScrollVertically: Boolean , initialAngle: Double , isClockwise: Boolean){
        this.itemsPerCircle=itemsPerCircle
        this.anglePerItem = anglePerItem
        this.firstCircleRadius = firstCircleRadius
        this.angleStepForCircles=angleStepForCircles
